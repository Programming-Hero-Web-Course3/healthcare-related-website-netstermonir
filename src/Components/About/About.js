...
import './About.css';
import aboutimg from '../../image/about/about-2.jpg';
                        ...
                        <div className="col-md-6 col-12">
                            <div className="about-text pt-3">
                                ...
                                <div>
                                    ...
                                    <div className="progress mb-2">
                                        <div className="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" style={{ width: '70%' }} aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">70%</div>
                                    </div>
                                </div>
                            </div>
                        </div>
